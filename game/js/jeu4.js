...
document.getElementById("ecran4oui").addEventListener("click", ecran4oui);
document.getElementById("ecran4non").addEventListener("click", ecran4non);

function ecran4oui() {
    calcul += nbEcran4;
    window.location.href="ecran5.html?calcul="+calcul;
}
