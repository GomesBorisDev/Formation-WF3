$(document).ready(function () {
    ...
    function success(pos) {
        ...
        $.getJSON('http://api.openweathermap.org/data/2.5/forecast?lat=' + crd.latitude + '&lon=' + crd.longitude + '&units=metric&lang=fr&appid=e7c7ab3d1ffa52efaf8bb27278322316', function (meteo) {
            console.log(meteo);
            ...
            switch (weather) {
                ...
                case "pluie modérée":
                    $("#weather").text(weather);
                    $("#icon").html('<img src="img/icon/petite-pluie.png" alt="légère pluie">')
                ...
                case "forte pluie":
                    $("#weather").text(weather);
                    $("#icon").html('<img src="img/icon/pluie.png" alt="orage et pluie fine">')
            ...
            getDates.forEach(function (value) {
                ...
                switch (weather) {
                    ...
                    case "orage et pluie fine":
                    case "forte pluie":
                        $("." + weatherWeek).html('<img src="img/icon/pluie.png" alt="orage et pluie fine">')
                        break;
    ...
    $("form").on("submit", function (e) {
        ...
        $.getJSON('http://api.openweathermap.org/data/2.5/forecast?q=' + town + '&units=metric&lang=fr&appid=e7c7ab3d1ffa52efaf8bb27278322316', function (meteo) {
